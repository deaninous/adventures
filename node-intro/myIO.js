...
var fs = require('fs')
function parseIO(){
  var newLineCount =  fs.readFileSync(process.argv[2]) //incoming
                  .toString() //from buffer to ascii
                  .match(/\n/g) //match newlines globaly
                  .length //get length of match; 1 macth == 1, so we get num matches this way
  return newLineCount

}
console.log(parseIO())
module.exports = parseIO